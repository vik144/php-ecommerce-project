    ...
    <section>
        <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
            <header>
                ...
                <p class="mt-4 max-w-md text-gray-500">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Itaque
                    praesentium cumque iure dicta incidunt est ipsam, officia dolor fugit natus?</p>
            </header>
                            ...
                            <details
                                ...
                                <div class="border-t border-gray-200 bg-white">
                                    <header class="flex items-center justify-between p-4">
                                        ...
                                        <button type="button"
                                            class="text-sm text-gray-900 underline underline-offset-4">Reset</button>
                                    </header>
                    ...
                    <ul class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        if($result->num_rows > 0){ ?>
                                      ...
                                      <li class="product-card">
                                          <?php
                                echo'
                                <a href="product_detail.php?id='. urlencode($row['srno']).'" class="group block overflow-hidden">
                                ';
                                ?>
                            ...
                            <div class="relative bg-white pt-3">
                                <h3 class="text-large text-gray-700 group-hover:underline group-hover:underline-offset-4">
                                    <b><?php echo $row["product_name"] ?></b></h3>

                                <p class="mt-2">
                                    <span class="sr-only"> Regular Price </span>

                                    <span class="tracking-wider text-gray-900">$ <?php echo $row["product_price"] ?> CAD
                                    </span>
                                </p>
                            </div>
                            </a>
